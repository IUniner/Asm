...
read:    
	...
	mov ah,0
        push bx     ;поместить цифру в стек.
...
processing:    
	mov bx, 0
	pop bx           ;достать цифру из стека.
	mul deci
        add bx, bx       ;прибавить произведение к результату.
        jc delete
	mov bx, deci
	mov deci, 10
        mul deci
        mov deci, bx     ;поместить новый множитель в deci.
        dec cx
...
firstnumb:
	...
	mov bx, minus1
	mov m1, bx ;есть ли у первого числа знак
